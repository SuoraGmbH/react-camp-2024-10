...
export const githubRepoFacebookReactSuccessMockHandler = http.get(
  ...
  ({ params }) => {
    ...
    return HttpResponse.json({
      ...
      updated_at: "2024-10-09T12:06:09Z",
      pushed_at: "2024-10-09T08:54:34Z",
